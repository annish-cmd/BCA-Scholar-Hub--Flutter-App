...
class _BcaSemesterPageState extends State<BcaSemesterPage> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> _fetchSemesterNotes() async {
    ...
    if (_currentSemesterString != _getSemesterString() || _semesterNotes.isEmpty) {
      setState(() {
        _isLoading = true;
        _errorMessage = '';
